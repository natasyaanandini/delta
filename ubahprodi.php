<?php
    ...
    if(isset($_GET['kd_prodi'])){
        $kode = $_GET['kd_prodi'];
        $data_prodi = $prodi->get_by_id($kode);
    }
    else
    {
    ...
    if(isset($_POST['tombol_ubah'])){
        ...
        $status_update = $prodi->update($kd_prodi, $nama_prodi);
        if($status_update){ ?>
          ...
          <script type="text/javascript">
            ...
            document.location='ubahprodi.php'
          </script>
          <?php
        }
      }
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="nama_prodi" type="text" class="form-control" value="<?php echo $data_prodi['nama_prodi']; ?>">
                                            </div>
                                            <div>
